        ...
        <nav className={`${bg} border-gray-900 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900`}>
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <Link href="/" className="flex items-center">
                    <Image src={logoSrc} width={24} height={24} className="mr-3 h-6 sm:h-9" />
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className={`flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:${bg} dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700`}>
                        ...
                        <button type="button" className="flex mr-3 text-sm text-black md:mr-0 focus:ring-4 focus:ring-gray-300">
                            ...
                            {/* <Link href="#" class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Logout</Link> */}
